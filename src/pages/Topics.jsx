  ...
  return (
    <div className="flex gap-8 px-8 py-6">
      <main className="w-full lg:w-4/5">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-[var(--primary-color-light)] dark:text-[var(--primary-color-dark)]">
            UI/UX Designing
          </h1>
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Projects &gt; UI/UX Designing
          </p>
        </div>

        <div className="bg-[var(--accent-light)] dark:bg-[var(--accent-dark)] p-6 rounded-lg shadow-sm mb-6 transition-colors duration-200">
          ...
          <div className="flex justify-between items-center mt-4">
            <div className="flex space-x-2">
              <button className="px-3 py-1 bg-gray-200 dark:bg-gray-700 rounded-lg text-gray-700 dark:text-gray-300">
                B
              </button>
              <button className="px-3 py-1 bg-gray-200 dark:bg-gray-700 rounded-lg text-gray-700 dark:text-gray-300">
                U
